...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: @tour.attributes
    end
  ...
  test "should show tour" do
    get :show, id: @tour.to_param
    assert_response :success
  end

  test "should get edit" do
    get :edit, id: @tour.to_param
    assert_response :success
  end

  test "should update tour" do
    put :update, id: @tour.to_param, tour: @tour.attributes
    assert_redirected_to tour_path(assigns(:tour))
  end

  test "should destroy tour" do
    assert_difference('Tour.count', -1) do
      delete :destroy, id: @tour.to_param
    end
